...
public class LightPost3 extends WorldGenerator
{
    ...
    public boolean generate(World world, Random rand, int i, int j, int k) {
        ...
        world.setBlock(i + 1, j + 2, k + 0, IceikaBlocks.coalstone);
        ...
        world.setBlock(i + 1, j + 4, k + 1, IceikaBlocks.workshopLamp);
        world.setBlock(i + 2, j + 0, k + 1, IceikaBlocks.coalstone);
        world.setBlock(i + 2, j + 2, k + 1, IceikaBlocks.coalstone);
