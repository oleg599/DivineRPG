...
public class LightPost4 extends WorldGenerator
{
    ...
    public boolean generate(World world, Random rand, int i, int j, int k) {
        ...
        world.setBlock(i + 0, j + 6, k + 1, IceikaBlocks.workshopLamp);
        world.setBlock(i + 0, j + 7, k + 1, IceikaBlocks.coalstone);
        ...
        world.setBlock(i + 1, j + 2, k + 1, IceikaBlocks.coalstone);
        world.setBlock(i + 1, j + 3, k + 1, IceikaBlocks.coalstone);
        world.setBlock(i + 1, j + 4, k + 1, IceikaBlocks.coalstone);
        world.setBlock(i + 1, j + 5, k + 1, IceikaBlocks.coalstone);
        world.setBlock(i + 1, j + 6, k + 0, IceikaBlocks.workshopLamp);
        world.setBlock(i + 1, j + 6, k + 1, IceikaBlocks.coalstone);
        world.setBlock(i + 1, j + 6, k + 2, IceikaBlocks.workshopLamp);
        ...
        world.setBlock(i + 2, j + 6, k + 1, IceikaBlocks.workshopLamp);
        world.setBlock(i + 2, j + 7, k + 1, IceikaBlocks.coalstone);
