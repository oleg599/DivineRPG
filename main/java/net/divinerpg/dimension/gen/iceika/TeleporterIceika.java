...
public class TeleporterIceika extends Teleporter{
    ...
    public TeleporterIceika(WorldServer par1WorldServer) {
    ...
    public void placeInPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            ...
            par1Entity.setLocationAndAngles((double)BlockIceikaPortal.x, (double)BlockIceikaPortal.y, (double)BlockIceikaPortal.z, par1Entity.rotationYaw, 0.0F);
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        {
            TeleporterIceika.PortalPosition portalposition = (TeleporterIceika.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
        ...
        else
        {
            for (l3 = l - short1; l3 <= l + short1; ++l3)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(l3, i2, l1) == IceikaBlocks.portal)
                        {
                            while (this.worldServerInstance.getBlock(l3, i2 - 1, l1) == IceikaBlocks.portal)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.destinationCoordinateCache.add(j1, new TeleporterIceika.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
            ...
            if (this.worldServerInstance.getBlock(i - 1, j, k) == IceikaBlocks.portal)
            {
                i4 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(i, j, k - 1) == IceikaBlocks.portal)
            {
                i4 = 3;
            }
        ...
        for (i3 = 0; i3 < 4; ++i3)
        {
            for (j3 = 0; j3 < 4; ++j3)
            {
                for (k3 = -1; k3 < 4; ++k3)
                {
                    ...
                    this.worldServerInstance.setBlock(l3, i4, j4, (flag ? Blocks.snow : IceikaBlocks.portal), 0, 2);
                }
            }
    ...
    public void removeStalePortalLocations(long par1)
    {
        if (par1 % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                TeleporterIceika.PortalPosition portalposition = (TeleporterIceika.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());
