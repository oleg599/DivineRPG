...
public class TeleporterVethea extends Teleporter{
    ...
    public void placeInPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            ...
            par1Entity.setLocationAndAngles((double)BlockVetheaPortal.x, (double)BlockVetheaPortal.y, (double)BlockVetheaPortal.z, par1Entity.rotationYaw, 0.0F);
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        {
            TeleporterVethea.PortalPosition portalposition = (TeleporterVethea.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
        ...
        else
        {
            for (l3 = l - short1; l3 <= l + short1; ++l3)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(l3, i2, l1) == VetheaBlocks.vetheaPortal)
                        {
                            while (this.worldServerInstance.getBlock(l3, i2 - 1, l1) == VetheaBlocks.vetheaPortal)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.destinationCoordinateCache.add(j1, new TeleporterVethea.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
            ...
            if (this.worldServerInstance.getBlock(i - 1, j, k) == VetheaBlocks.vetheaPortal)
            {
                i4 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(i, j, k - 1) == VetheaBlocks.vetheaPortal)
            {
                i4 = 3;
            }
    ...
    private void makePortal(World var1, int var2, int var3, int var4)
    {
        if (var3 < 30)
        {
            var3 = 30;
        ...
        var1.setBlock(var2 + 0, var3 + 0, var4 + 1, TwilightBlocks.mortumBlock);
        var1.setBlock(var2 + 0, var3 + 0, var4, TwilightBlocks.mortumBlock);
        var1.setBlock(var2 - 0, var3 + 0, var4 + 2, TwilightBlocks.mortumBlock);
        ...
        for (int var5 = -1; var5 <= 2; ++var5)
        {
            for (int var6 = -1; var6 <= 2; ++var6)
            {
                ...
                {
                    var1.setBlock(var2 + var5, var3 + var7, var4 + var6, null);
                }
            }
        }

        var1.setBlock(var2 - 1, var3 + 1, var4 + 1, TwilightBlocks.mortumBlock);
        var1.setBlock(var2 + 1, var3 + 1, var4 + 1, TwilightBlocks.mortumBlock);
        var1.setBlock(var2 - 2, var3 + 2, var4 + 1, TwilightBlocks.mortumBlock);
        var1.setBlock(var2 + 2, var3 + 2, var4 + 1, TwilightBlocks.mortumBlock);
        var1.setBlock(var2 + 1, var3 + 3, var4 + 1, TwilightBlocks.mortumBlock);
        var1.setBlock(var2 - 1, var3 + 3, var4 + 1, TwilightBlocks.mortumBlock);
        var1.setBlock(var2, var3 + 4, var4 + 1, TwilightBlocks.mortumBlock);
        var1.setBlock(var2, var3 + 1, var4 + 1, VetheaBlocks.vetheaPortal);
        var1.setBlock(var2 + 1, var3 + 2, var4 + 1, VetheaBlocks.vetheaPortal);
        var1.setBlock(var2, var3 + 2, var4 + 1, VetheaBlocks.vetheaPortal);
        var1.setBlock(var2 - 1, var3 + 2, var4 + 1, VetheaBlocks.vetheaPortal);
        var1.setBlock(var2, var3 + 3, var4 + 1, VetheaBlocks.vetheaPortal);
    }
            ...
            for (i3 = -1; i3 <= 1; ++i3)
            {
                for (j3 = 1; j3 < 3; ++j3)
                {
                    for (k3 = -1; k3 < 3; ++k3)
                    {
                        ...
                        j4 = k2 + (j3 - 1) * l2 - i3 * l5;
                        flag = k3 < 0;
                        this.worldServerInstance.setBlock(l3, i4, j4, flag ? TwilightBlocks.mortumBlock : Blocks.air);
                    }
                }
            }
        }
        ...
        for (i3 = 0; i3 < 4; ++i3)
        {
            for (j3 = 0; j3 < 4; ++j3)
            {
                for (k3 = -1; k3 < 4; ++k3)
                {
                    ...
                    this.worldServerInstance.setBlock(l3, i4, j4, (flag ? TwilightBlocks.mortumBlock : VetheaBlocks.vetheaPortal), 0, 2);
                }
            }
    ...
    public void removeStalePortalLocations(long par1)
    {
        if (par1 % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                TeleporterVethea.PortalPosition portalposition = (TeleporterVethea.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());
