...
public class ToolMaterialMod {
    ...
    public static ToolMaterial Snowslash      = Util.addMeleeMaterial(150, 38, 15);
    public static ToolMaterial Glacier        = Util.addMeleeMaterial(1000, 18, 15);
    public static ToolMaterial Frostking      = Util.addMeleeMaterial(6000, 16, 15);
    ...
    public static ToolMaterial AquaMaul       = Util.addMeleeMaterial(10000, 29, 10);
    public static ToolMaterial Donator        = Util.addMeleeMaterial(5000, 12, 22);
    public static ToolMaterial AquaDagger     = Util.addMeleeMaterial(2000, 10, 15);
    public static ToolMaterial AquaTrident    = Util.addMeleeMaterial(7000, 15, 15);
    public static ToolMaterial Aquaton        = Util.addMeleeMaterial(10000, 18, 15);
    public static ToolMaterial Frost          = Util.addMeleeMaterial(5000, 10, 15);
    public static ToolMaterial Molten         = Util.addMeleeMaterial(5000, 10, 15);
    public static ToolMaterial Shark          = Util.addMeleeMaterial(2000, 12, 15);
    public static ToolMaterial DeathBringer   = Util.addMeleeMaterial(6000, 13, 15);
    public static ToolMaterial CrabclawMaul   = Util.addMeleeMaterial(4000, 16, 15);
    public static ToolMaterial PoisonSaber    = Util.addMeleeMaterial(10000, 16, 15);
    public static ToolMaterial FuryMaul       = Util.addMeleeMaterial(14, 15);
    public static ToolMaterial Scorching      = Util.addMeleeMaterial(500, 26, 15);
    public static ToolMaterial Bluefire       = Util.addMeleeMaterial(3000, 24, 15);
    public static ToolMaterial CorruptedMaul  = Util.addMeleeMaterial(6000, 18, 15);
    public static ToolMaterial Halite         = Util.addMeleeMaterial(2000, 82, 22);
    public static ToolMaterial Skythern       = Util.addMeleeMaterial(6000, 64, 22);
    public static ToolMaterial Eden           = Util.addMeleeMaterial(6000, 36, 22);
    public static ToolMaterial Wildwood       = Util.addMeleeMaterial(6000, 44, 22);
    public static ToolMaterial Apalachia      = Util.addMeleeMaterial(6000, 54, 22);
    public static ToolMaterial Mortum         = Util.addMeleeMaterial(6000, 76, 22);
    public static ToolMaterial Arlemite       = Util.addMeleeMaterial(4000, 9, 10);
    public static ToolMaterial Sandslash      = Util.addMeleeMaterial(200, 27, 22);
    public static ToolMaterial Rupee          = Util.addMeleeMaterial(2500, 9, 15);
    public static ToolMaterial Inferno        = Util.addMeleeMaterial(9, 22);
    public static ToolMaterial Cyclops        = Util.addMeleeMaterial(1000, 8, 10);
    public static ToolMaterial Bloodgem       = Util.addMeleeMaterial(520, 9, 15);
