...
public class EntityHelio extends EntityDivineRPGMob
{
    ...
    public EntityHelio(World var1)
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(64.0); // Follow range
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(140); // MaxHP
    }
