...
public class EntityWreck extends EntityDivineRPGBoss implements IRangedAttackMob, IBossDisplayData
{
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(5000); // MaxHP
        this.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(128.0); // FollowRange
    }
                ...
                case MELEE:
                    switch(this.rand.nextInt(2))
                    {
                        case 0:
                            ...
                            this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.0F); // Speed
                            break;
                        case 1:
                            ability = CHARGE;
