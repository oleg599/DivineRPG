...
public class EntityKaros extends EntityDivineRPGBoss implements IBossDisplayData
{
    ...
    public EntityKaros(World par1)
    {
        ...
        ability = DEFAULT;
        this.playSound(""/*Sound.KarosIntro*/, 1.0F, 1.0F);
    }
    ...
    protected String getLivingSound()
    {
        ...
        {
            case 0:
                return "";//Sound.KarosLaugh;
            case 1:
                return "";//Sound.MeetDoom;
            case 2:
                return "";//Sound.TryYourBest;
            default:
                return "";//Sound.YouCantKillMe;
        }
    }
