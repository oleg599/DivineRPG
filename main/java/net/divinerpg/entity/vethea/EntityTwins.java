...
public class EntityTwins extends EntityDivineRPGMob implements IRangedAttackMob
{
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(1); // Attack
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(1); // MaxHP
    }
