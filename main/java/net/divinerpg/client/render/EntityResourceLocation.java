...
public class EntityResourceLocation {
    ...
    public static ResourceLocation apalachiaTomo	 = addMob("apalachiaGomo");
    ...
    public static ResourceLocation WRECK 			 = addMob("wreck");
    ...
    public static ResourceLocation MM1				 = addMob("mysteriousManLayer1");
    public static ResourceLocation MM2				 = addMob("mysteriousManLayer2");
    public static ResourceLocation MM3				 = addMob("mysteriousManLayer3");
