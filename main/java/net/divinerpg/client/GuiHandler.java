...
import net.divinerpg.client.render.gui.GuiDivineMerchent;
...
public class GuiHandler implements IGuiHandler{
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if(ID == merchent)
			return new GuiDivineMerchent(new ContainerDivineMerchant(player.inventory, (IMerchant)getEntityByID(x, world), world), (IMerchant)getEntityByID(x, world), "", "workshopWorker");
