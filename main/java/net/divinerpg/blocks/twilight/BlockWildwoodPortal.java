...
import net.divinerpg.entity.twilight.effects.EntityWildWoodPortalFX;
...
public class BlockWildwoodPortal extends BlockBreakable
{
	...
	{
		BlockWildwoodPortal.Size size = new BlockWildwoodPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
		BlockWildwoodPortal.Size size1 = new BlockWildwoodPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
	{
		...
		BlockWildwoodPortal.Size size = new BlockWildwoodPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
		BlockWildwoodPortal.Size size1 = new BlockWildwoodPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
	...
	public static class Size
	{
		...
		public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
		{
			...
			this.field_150863_d = BlockWildwoodPortal.field_150001_a[p_i45415_5_][0];
			this.field_150866_c = BlockWildwoodPortal.field_150001_a[p_i45415_5_][1];
		...
		protected int func_150853_a(int p_150853_1_, int p_150853_2_, int p_150853_3_, int p_150853_4_)
		{
			...
			for (i1 = 0; i1 < 22; ++i1)
			{
				...
				if (block1 != TwilightBlocks.edenBlock)
				{
					break;
				}
			}
			...
			block = this.field_150867_a.getBlock(p_150853_1_ + j1 * i1, p_150853_2_, p_150853_3_ + k1 * i1);
			return block == TwilightBlocks.edenBlock ? i1 : 0;
		}
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					...
					{
						k = this.field_150861_f.posX + j * Direction.offsetX[BlockWildwoodPortal.field_150001_a[this.field_150865_b][1]];
						l = this.field_150861_f.posZ + j * Direction.offsetZ[BlockWildwoodPortal.field_150001_a[this.field_150865_b][1]];
						...
						if (j == 0)
						{
							block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockWildwoodPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[BlockWildwoodPortal.field_150001_a[this.field_150865_b][0]]);

							if (block != TwilightBlocks.edenBlock)
							{
								break label56;
							}
						}
						...
						{
							block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockWildwoodPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[BlockWildwoodPortal.field_150001_a[this.field_150865_b][1]]);
			...
			{
				j = this.field_150861_f.posX + i * Direction.offsetX[BlockWildwoodPortal.field_150001_a[this.field_150865_b][1]];
				k = this.field_150861_f.posY + this.field_150862_g;
				l = this.field_150861_f.posZ + i * Direction.offsetZ[BlockWildwoodPortal.field_150001_a[this.field_150865_b][1]];

				if (this.field_150867_a.getBlock(j, k, l) != TwilightBlocks.edenBlock)
				{
