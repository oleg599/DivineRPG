...
import net.divinerpg.dimension.gen.vethea.TeleporterVethea;
import net.divinerpg.entity.twilight.effects.EntityEdenPortalFX;
...
public class BlockVetheaPortal extends BlockBreakable
{
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity) {
        if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP))) {
        	int dim = ConfigurationHelper.vethea;
            ...
            if (thePlayer.timeUntilPortal > 0) {
            	...
            	System.out.print(y);
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, dim, new TeleporterVethea(thePlayer.mcServer.worldServerForDimension(dim)));
            } else {
                thePlayer.timeUntilPortal = 10;
	...
	{
		BlockVetheaPortal.Size size = new BlockVetheaPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
		BlockVetheaPortal.Size size1 = new BlockVetheaPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
	{
		...
		BlockVetheaPortal.Size size = new BlockVetheaPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
		BlockVetheaPortal.Size size1 = new BlockVetheaPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
	...
	public static class Size
	{
		...
		public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
		{
			...
			this.field_150863_d = BlockVetheaPortal.field_150001_a[p_i45415_5_][0];
			this.field_150866_c = BlockVetheaPortal.field_150001_a[p_i45415_5_][1];
		...
		protected int func_150853_a(int p_150853_1_, int p_150853_2_, int p_150853_3_, int p_150853_4_)
		{
			...
			for (i1 = 0; i1 < 22; ++i1)
			{
				...
				if (block1 != TwilightBlocks.mortumBlock)
				{
					break;
				}
			}
			...
			block = this.field_150867_a.getBlock(p_150853_1_ + j1 * i1, p_150853_2_, p_150853_3_ + k1 * i1);
			return block == TwilightBlocks.mortumBlock ? i1 : 0;
		}
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					...
					{
						k = this.field_150861_f.posX + j * Direction.offsetX[BlockVetheaPortal.field_150001_a[this.field_150865_b][1]];
						l = this.field_150861_f.posZ + j * Direction.offsetZ[BlockVetheaPortal.field_150001_a[this.field_150865_b][1]];
						...
						if (block == VetheaBlocks.vetheaPortal)
						{
							++this.field_150864_e;
						}
						...
						if (j == 0)
						{
							block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockVetheaPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[BlockVetheaPortal.field_150001_a[this.field_150865_b][0]]);

							if (block != TwilightBlocks.mortumBlock)
							{
								break label56;
							}
						}
						...
						{
							block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockVetheaPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[BlockVetheaPortal.field_150001_a[this.field_150865_b][1]]);
			...
			{
				j = this.field_150861_f.posX + i * Direction.offsetX[BlockVetheaPortal.field_150001_a[this.field_150865_b][1]];
				k = this.field_150861_f.posY + this.field_150862_g;
				l = this.field_150861_f.posZ + i * Direction.offsetZ[BlockVetheaPortal.field_150001_a[this.field_150865_b][1]];

				if (this.field_150867_a.getBlock(j, k, l) != TwilightBlocks.mortumBlock)
				{
		...
		{
			return block.getMaterial() == Material.air || block == TwilightBlocks.blueFire || block == VetheaBlocks.vetheaPortal;
		}
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				for (int l = 0; l < this.field_150862_g; ++l)
				{
					...
					this.field_150867_a.setBlock(j, i1, k, VetheaBlocks.vetheaPortal, this.field_150865_b, 2);
				}
			}
		}
	}
