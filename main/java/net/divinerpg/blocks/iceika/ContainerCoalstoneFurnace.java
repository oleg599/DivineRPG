...
public class ContainerCoalstoneFurnace extends Container
{
    ...
    public ContainerCoalstoneFurnace(InventoryPlayer par1InventoryPlayer, TileEntityCoalstoneFurnace par2TileEntityFurnace)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (par2 != 1 && par2 != 0)
            {
                ...
                else if (TileEntityCoalstoneFurnace.isItemFuel(itemstack1))
                {
