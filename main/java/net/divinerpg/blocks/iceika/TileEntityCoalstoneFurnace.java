...
public class TileEntityCoalstoneFurnace extends TileEntity implements ISidedInventory {
    ...
    {
        return this.hasCustomInventoryName() ? this.field_145958_o : "Coalstone Furnace";
    }
