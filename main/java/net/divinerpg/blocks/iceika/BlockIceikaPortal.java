...
public class BlockIceikaPortal extends BlockBreakable
{
	...
	public String name;
	public BlockIceikaPortal() {
		super(Reference.PREFIX + "iceikaPortal", Material.portal, false);
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity) {
        if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP))) {
        	int dim = ConfigurationHelper.Iceika;
            ...
            if (thePlayer.timeUntilPortal > 0) {
            	...
            	System.out.print(y);
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, dim, new TeleporterIceika(thePlayer.mcServer.worldServerForDimension(dim)));
            } else {
                thePlayer.timeUntilPortal = 10;
	...
	{
		BlockIceikaPortal.Size size = new BlockIceikaPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
		BlockIceikaPortal.Size size1 = new BlockIceikaPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
	{
		...
		BlockIceikaPortal.Size size = new BlockIceikaPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
		BlockIceikaPortal.Size size1 = new BlockIceikaPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
	...
	public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
	{
		for (int l = 0; l < 4; ++l)
		{
			...
			EntityGreenPortalFX var20 = new EntityGreenPortalFX(p_149734_1_, d0, d1, d2, d3, d4, d5);
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					...
					for (j = 0; j < this.field_150868_h; ++j)
					{
						...
						if (j == 0)
						{
							block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockIceikaPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[BlockIceikaPortal.field_150001_a[this.field_150865_b][0]]);
						...
						{
							block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockIceikaPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[BlockIceikaPortal.field_150001_a[this.field_150865_b][1]]);
