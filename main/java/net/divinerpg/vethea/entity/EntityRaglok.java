...
public class EntityRaglok extends EntityDivineRPGBoss implements IRangedAttackMob, IBossDisplayData {
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(64.0); // FollowRange
    }
