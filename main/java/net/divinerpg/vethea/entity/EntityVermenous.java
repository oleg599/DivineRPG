...
public class EntityVermenous extends EntityDivineRPGMob
{
    ...
    public EntityVermenous(World var1)
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(19); // Attack
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(100); // MaxHP
