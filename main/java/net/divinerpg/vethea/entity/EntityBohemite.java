...
public class EntityBohemite extends EntityDivineRPGMob
{
    ...
    public EntityBohemite(World var1)
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(64.0);
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(13); // Attack
