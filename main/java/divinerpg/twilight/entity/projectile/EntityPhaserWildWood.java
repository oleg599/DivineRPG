...
public class EntityPhaserWildWood extends EntityThrowable
{
    public EntityPhaserWildWood(World var1)
    {
        super(var1);
    }

    public EntityPhaserWildWood(World var1, EntityPlayer var3)
    {
        super(var1, var3);
    }

    public EntityPhaserWildWood(World var1, double var2, double var4, double var6)
    {
