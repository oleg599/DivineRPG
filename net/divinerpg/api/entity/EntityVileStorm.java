 ...
 *
 * <strong>Class:</strong> EntityVileStorm
 *
...
public class EntityVileStorm extends EntityThrowable {
    ...
    public EntityVileStorm(World par1World) {
        super(par1World);
    }
    
    public EntityVileStorm(World par1World, EntityLivingBase par2Entity){
        super(par1World, par2Entity);
    }
    
    public EntityVileStorm(World par1World, double par2, double par3, double par4){
