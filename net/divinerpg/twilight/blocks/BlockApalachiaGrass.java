...
public class BlockApalachiaGrass extends Block {
    ...
    public void func_149674_a(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                par1World.func_147449_b(par2, par3, par4, TwilightBlocks.apalachiaDirt);
            }
            else if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 9)
            {
                for (int l = 0; l < 4; ++l)
                {
                    ...
                    if (par1World.func_147439_a(i1, j1, k1) == TwilightBlocks.apalachiaDirt && par1World.getBlockLightValue(i1, j1 + 1, k1) >= 4 && par1World.getBlockLightOpacity(i1, j1 + 1, k1) <= 2)
                    {
                        par1World.func_147449_b(i1, j1, k1, TwilightBlocks.apalachiaGrass);
                    }
                }
            }
        }
    ...
    public Item func_149650_a(int par1, Random par2Random, int par3) {
        return Item.func_150898_a(TwilightBlocks.apalachiaDirt);
    }
