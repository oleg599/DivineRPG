...
public class BlockSkythernGrass extends Block {
    ...
    public void func_149651_a(IIconRegister icon) {
        this.field_149761_L = icon.registerIcon(Reference.prefix + "skytherngrass_side");
        this.top = icon.registerIcon(Reference.prefix + "skytherngrass_top");
