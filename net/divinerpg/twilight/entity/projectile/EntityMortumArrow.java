...
public class EntityMortumArrow extends EntityArrow
{
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    {
                        damagesource = DamageSourceHelper.mortumArrowDamage(this, this);
                    }
                    else
                    {
                        damagesource = DamageSourceHelper.mortumArrowDamage(this, this.shootingEntity);
                    }
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(TwilightItems.mortumArrow, 1)))
            {
                flag = false;
            }
