...
public class ChunkProviderEden implements IChunkProvider{
    ...
    public void replaceBlocksForBiome(int var1, int var2, Block[] var3)
    {
        ...
        for (int var8 = 0; var8 < 16; ++var8)
        {
            for (int var9 = 0; var9 < 16; ++var9)
            {
                ...
                int var13 = -1;
                Block var14 = TwilightBlocks.edenGrass;
	...
	public void populate(IChunkProvider ichunkprovider, int i, int j) {
	        ...
	        for (var13 = 0; var13 < 17; ++var13)
	        {
	            ...
	            (new WorldGenMinable(TwilightBlocks.edenOre, 9, TwilightBlocks.twilightStone)).generate(this.worldObj, this.rand, var14, var15, var16);
	        }
	        ...
	        /*WorldGenSerenityTrees var17 = new WorldGenSerenityTrees(true);
	        int var19;
	        int var18;
