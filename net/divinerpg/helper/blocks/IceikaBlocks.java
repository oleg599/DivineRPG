...
import net.divinerpg.iceika.blocks.IceikaSpawner;
...
public class IceikaBlocks {
	...
	public static final Block rollumSpawner 	  = new IceikaSpawner("Creeper").setName("frozenDungonSpawner").setHardness(5.0F);//change mob to spawn to rollum
	public static final Block glacideSpawner 	  = new IceikaSpawner("Enderman").setName("frozenDungonSpawner").setHardness(5.0F);//change mob to spawn to glacide
