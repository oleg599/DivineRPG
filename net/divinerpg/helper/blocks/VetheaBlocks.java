...
public class VetheaBlocks {
  ...
  //public static final BlockVetheaPortal vetheaPortal           = (BlockVetheaPortal)new BlockVetheaPortal().setName("vetheaPortal").setCreativeTab(DivineRPGTabs.vethea);
    ...
    public static final Block             bacterialAcid          = new BlockAcid().setName("VetheaPortal").setHardness(1F).setCreativeTab(DivineRPGTabs.vethea);
    ...
    public static final Block             lunicAcid              = new BlockAcid().setName("VetheaPortal").setHardness(1F).setCreativeTab(DivineRPGTabs.vethea);
