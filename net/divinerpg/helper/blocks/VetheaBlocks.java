...
public class VetheaBlocks{
	...
	public static final Block dreamLampOn = new BlockDreamLamp(30, Material.glass, true).setName("dreamLampOn").setBlockUnbreakable().setHardness(1F).setLightLevel(1.0F).setCreativeTab(DivineRPGTabs.vethea);
	public static final Block dreamLamp = new BlockDreamLamp(31, Material.glass, false).setName("dreamLampOff").setBlockUnbreakable().setHardness(1F).setStepSound(Block.soundTypeGlass).setCreativeTab(DivineRPGTabs.vethea);
	...
	public static final Block barredDoor = new BlockBarredDoor(Material.wood, "BarredDoor").setHardness(1F).setCreativeTab(null);
	...
	public static final Block mintwoodLeaves = new ModLeaves("MintWood").setUnlocalizedName("mintwoodLeaves").setHardness(1F).setCreativeTab(DivineRPGTabs.vethea);
	public static final Block firewall = new BlockMod(Material.rock).setName("FireWall").setCreativeTab(DivineRPGTabs.vethea);
	public static final Block karosHeatTileGreen = new BlockKarosHeatTile(false).setName("KarosHeatTileGreen").setBlockUnbreakable().setUnlocalizedName("karosHeatTileGreen").setCreativeTab(DivineRPGTabs.vethea);
	public static final Block karosHeatTileRed = new BlockKarosHeatTile(true).setName("KarosHeatTileRed").setBlockUnbreakable().setUnlocalizedName("karosHeatTileRed").setCreativeTab(DivineRPGTabs.vethea);
	...
	public static final Block firewoodLeaves = new ModLeaves("FireWood").setUnlocalizedName("firewoodLeaves").setHardness(1F).setCreativeTab(DivineRPGTabs.vethea);
	public static final Block hyrewoodLeaves = new ModLeaves("HyreWood").setUnlocalizedName("hyrewoodLeaves").setHardness(1F).setCreativeTab(DivineRPGTabs.vethea);
	public static final Block gemtopGreen = new BlockModPlant().setName("GreenGemTop").setUnlocalizedName("gemtopGreen").setCreativeTab(DivineRPGTabs.vethea);
	public static final Block gemtopPurple = new BlockModPlant().setName("PurpleGemTop").setUnlocalizedName("gemtopPurple").setCreativeTab(DivineRPGTabs.vethea);
	public static final Block yellowDulah = new BlockModPlant().setName("YellowDulah").setUnlocalizedName("yellowDulah").setCreativeTab(DivineRPGTabs.vethea);
	public static final Block greenDulah = new BlockModPlant().setName("GreenDulah").setUnlocalizedName("greenDulah").setCreativeTab(DivineRPGTabs.vethea);
	public static final Block mintwood = new BlockModLog().setUnlocalizedName("mint").setHardness(1F).setCreativeTab(DivineRPGTabs.vethea);
	public static final Block lightFirewoodLeaves = new ModLeaves("FireWood").setUnlocalizedName("lightFirewoodLeaves").setHardness(1F).setCreativeTab(DivineRPGTabs.vethea);
	public static final Block cracklespike = new BlockModPlant().setName("CrackleSpike").setUnlocalizedName("cracklespike").setStepSound(Block.soundTypeGrass).setCreativeTab(DivineRPGTabs.vethea);
	public static final Block fernite = new BlockModPlant().setName("Fernite").setUnlocalizedName("Fernite").setStepSound(Block.soundTypeGrass).setCreativeTab(DivineRPGTabs.vethea);
	public static final Block bulatobe = new BlockModPlant().setName("Bulbatobe").setUnlocalizedName("Bulbatobe").setStepSound(Block.soundTypeGrass).setCreativeTab(DivineRPGTabs.vethea);
	public static final Block shineGrass = new BlockModPlant().setName("ShineGrass").setUnlocalizedName("ShineGrass").setLightLevel(0.4F).setStepSound(Block.soundTypeGrass).setCreativeTab(DivineRPGTabs.vethea);
	...
	public static final Block hyrewoodVine = new BlockModVine("WeedWood").setUnlocalizedName("hyrewoodVine").setHardness(1F).setCreativeTab(DivineRPGTabs.vethea);
	public static final Block dreambricks2 = new BlockMod(Material.rock).setName("DreamBricks2").setUnlocalizedName("dreambricks").setHardness(1F).setCreativeTab(DivineRPGTabs.vethea);
	...
	public static final Block purpleFire = new BlockPurpleFire();
