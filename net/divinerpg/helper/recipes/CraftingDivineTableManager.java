...
import net.divinerpg.helper.recipes.modded.RecipeBookCloning;
import net.divinerpg.helper.recipes.modded.RecipeFireworks;
import net.divinerpg.helper.recipes.modded.RecipesArmor;
import net.divinerpg.helper.recipes.modded.RecipesArmorDyes;
import net.divinerpg.helper.recipes.modded.RecipesCrafting;
import net.divinerpg.helper.recipes.modded.RecipesDyes;
import net.divinerpg.helper.recipes.modded.RecipesFood;
import net.divinerpg.helper.recipes.modded.RecipesIngots;
import net.divinerpg.helper.recipes.modded.RecipesMapCloning;
import net.divinerpg.helper.recipes.modded.RecipesMapExtending;
import net.divinerpg.helper.recipes.modded.RecipesTools;
import net.divinerpg.helper.recipes.modded.RecipesWeapons;
...
public class CraftingDivineTableManager {

    private static final CraftingDivineTableManager instance = new CraftingDivineTableManager();
    private List recipes = new ArrayList();

    public static final CraftingDivineTableManager getInstance() {
        return instance;
    }
    ...
    public DivineShapedRecipes addRecipe(ItemStack par1ItemStack, Object ... par2ArrayOfObj)
    {
        ...
        DivineShapedRecipes DivineShapedRecipes = new DivineShapedRecipes(j, k, aitemstack, par1ItemStack);
        this.recipes.add(DivineShapedRecipes);
        return DivineShapedRecipes;
    }
    ...
    public void addShapelessRecipe(ItemStack par1ItemStack, Object ... par2ArrayOfObj)
    {
        ...
        this.recipes.add(new DivineShapelessRecipes(par1ItemStack, arraylist));
    }
