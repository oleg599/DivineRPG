...
public class IceikaItems {
	...
	public static final Item soundOfCarols     = new ItemMod().setName("soundofCarols").setCreativeTab(DivineRPGTabs.ranged);
	...
	public static final Item santaHead		   = new ItemDivineArmor(ArmorMaterialMod.Santa, HEAD, 0, true, "santa").setName("santaHelmet");
	public static final Item santaBody 		   = new ItemDivineArmor(ArmorMaterialMod.Santa, BODY, 1, true, "santa").setName("santaBody");
